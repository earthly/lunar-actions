...
| `rerun-catalogers` | no | `false` | Rerun global catalogers after pulling. Per-component catalogers (`component-repo` / `component-cron`) are unaffected and continue to run on their own hooks. **Requires lunar v1.0.11+.** |
